...
> *"Um leitor vive mil vidas antes de morrer. O homem que nunca lê vive apenas uma."* - George R.R. Martin
  ...
  },
  {
    "id": "rick-riordan",
    "nome": "Rick Riordan",
    "imagem": "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Rick_Riordan_%2810442%29.jpg/1024px-Rick_Riordan_%2810442%29.jpg",
    "biografia": `
# Rick Riordan

**Richard Russell Riordan Jr.**, mais conhecido como **Rick Riordan**, é um escritor norte-americano, autor de várias séries de fantasia, sendo a mais famosa a série **"Percy Jackson e os Olimpianos"**, que mistura mitologia grega com aventuras modernas. Nascido em 5 de junho de 1964, em San Antonio, Texas, Riordan se destacou como autor infantojuvenil, criando histórias que atraem leitores de todas as idades.

## Primeiros Anos e Início da Carreira
Riordan começou sua carreira como professor de inglês e história. Foi durante seu tempo como educador que ele começou a contar histórias para seus filhos, utilizando mitologia grega. Essas histórias deram origem à série *Percy Jackson e os Olimpianos*, que se tornou um enorme sucesso internacional.

## A Criação de Percy Jackson
Em 2005, Rick Riordan publicou o primeiro livro de *Percy Jackson e os Olimpianos*, intitulado **"Percy Jackson e o Ladrão de Raios"**. A série seguiu o personagem Percy Jackson, um adolescente que descobre ser filho de Poseidon, o deus grego do mar. A série, composta por cinco livros, foi extremamente popular, com mais de 35 milhões de cópias vendidas em todo o mundo e traduzida para mais de 40 idiomas. Os livros da série incluem:

1. **Percy Jackson e o Ladrão de Raios** (2005)
2. **Percy Jackson e o Mar de Monstros** (2006)
3. **Percy Jackson e a Maldição do Titã** (2007)
4. **Percy Jackson e a Batalha do Labirinto** (2008)
5. **Percy Jackson e o Último Olimpiano** (2009)

## Expansão do Universo de Percy Jackson
O sucesso de *Percy Jackson* levou Riordan a expandir o universo mitológico, criando outras séries como:

- **Os Heróis do Olimpo** - Uma sequência que mistura mitologia grega e romana.
- **As Provações de Apolo** - Uma série sobre o deus Apolo, banido do Monte Olimpo.
- **Magnus Chase e os Deuses de Asgard** - Focada na mitologia nórdica.
- **As Crônicas dos Kane** - Baseada na mitologia egípcia.

## Vida Pessoal e Legado
Além de sua carreira literária, Riordan é ativo em causas educacionais e filantrópicas, apoiando programas de incentivo à leitura e escrevendo livros que abordam temas como a aceitação e a identidade. Rick Riordan é amplamente reconhecido por sua habilidade em envolver jovens leitores e ensinar história e mitologia de uma forma divertida e acessível.

---

> *"A verdadeira magia está em ser capaz de ver o mundo através de novos olhos."* - Rick Riordan
    `
  }
];
